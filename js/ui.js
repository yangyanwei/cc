...
function switchPptToVideo(){
	if( $('#widget-video').is(':animated') ){ return false; }
    ...
    if ( winMain == 1 ){
        ...
        pptStyle = { 'width': videoWidth, 'height': videoHeight, 'left': videoLeft, 'right': videoRight, 'z-index': videoZindex },
        videoStyle = { 'width': pptWidth, 'height': pptHeight, 'left': pptLeft, 'right': pptRight, 'z-index':  pptZindex };
